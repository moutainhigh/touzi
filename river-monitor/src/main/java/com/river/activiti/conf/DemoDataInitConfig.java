package com.river.activiti.conf;
...
import com.river.activiti.util.PropertyFileUtil;
...
public class DemoDataInitConfig {
    ...
    protected void initDemoUsers() {
        createUser("admin", "Henry", "Yan", "000000", "henry.yan@yinovo.com",
                "", Arrays.asList("user", "admin"), null);

        createUser("hruser", "Lili", "Zhang", "000000", "lili.zhang@yinovo.com",
                "", Arrays.asList("hr", "user"), null);

        createUser("leaderuser", "Jhon", "Li", "000000", "jhon.li@yinovo.com",
                "", Arrays.asList("deptLeader", "user"), null);

        createUser("huangping", "Coffee", "Rabbit", "000000", "coffee.rabbit@yinovo.com",
                "", Arrays.asList("user", "admin"), null);
    }
