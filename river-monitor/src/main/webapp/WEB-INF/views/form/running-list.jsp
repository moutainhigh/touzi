<%@page import="com.river.activiti.util.ProcessDefinitionCache,org.activiti.engine.RepositoryService"%>
                        ...
                        <table>
                            ...
                            <c:forEach items="${page.result }" var="p">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="trace" href='#' pid="${p.id }" pdid="${p.processDefinitionId}" title="点击查看流程图">
