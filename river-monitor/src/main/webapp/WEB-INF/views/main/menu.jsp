...
<ul id="css3menu">
	<li class="topfirst"><a rel="main/welcome">首页</a></li>
		...
		<a rel="#">立项申请</a>
		<ul>
			<li><a rel="business/setup/apply">立项申请</a></li>
			<li><a rel="business/setup/list/task">申请审核</a></li>
			<li><a rel="business/setup/list/running">运行中流程</a></li>
			<li><a rel="business/setup/list/finished">已结束流程</a></li>
		</ul>
	</li>
		<li style="display:none">
		<a rel="#">可研申请</a>
		<ul>
			<li><a rel="business/feasibility/apply">可研申请</a></li>
			<li><a rel="business/feasibility/list/task">可研申请审核</a></li>
		</ul>
	</li>
			<li style="display:none">
		<a rel="#">投决申请</a>
		<ul>
			<li><a rel="business/decision/apply">投决申请</a></li>
			<li><a rel="business/decision/list/task">投决申请审核</a></li>
		</ul>
	</li>
				<li style="display:none">
		<a rel="#">变更申请</a>
		<ul>
			<li><a rel="business/modification/apply">变更申请</a></li>
			<li><a rel="business/modification/list/task">变更申请审核</a></li>
		</ul>
	</li>
